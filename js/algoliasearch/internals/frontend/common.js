document.addEventListener("DOMContentLoaded", function (e) {
	algoliaBundle.$(function ($) {
		...
		window.transformHit = function (hit, price_key, helper) {
			...
			// Expire the special_price if needed.
      if (hit['price'][algoliaConfig.currencyCode]['special_to_date']) {
				var special_to_date = hit['price'][algoliaConfig.currencyCode]['special_to_date'];
				if (algoliaConfig.current_timestamp > special_to_date) {
          var default_original_formated = hit['price'][algoliaConfig.currencyCode]['default_original_formated']
          hit['price'][algoliaConfig.currencyCode]['default_original_formated'] = false;
          hit['price'][algoliaConfig.currencyCode]['default_formated'] = default_original_formated;
				}
			}
